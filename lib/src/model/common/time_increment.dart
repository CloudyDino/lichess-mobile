...
class TimeIncrement implements Comparable<TimeIncrement> {
  ...
  /// Clock simple (US) delay in seconds.
  ///
  /// The active side's clock waits this many seconds before counting down on
  /// each move. Only used by the local clock tool: lichess online play does not
  /// support delay.
  final int delay;
